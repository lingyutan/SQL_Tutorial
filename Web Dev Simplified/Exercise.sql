...
-- Question 3
SELECT * FROM albums
WHERE release_year IN (SELECT MIN(release_year) FROM albums);
...
GROUP BY albums.id 												/* or songs.album_id*/
...
INSERT INTO bands (name) VALUES ('May Day');

SELECT * FROM bands;

INSERT INTO albums(name,release_year,band_id) VALUES ('History of Tomorrow',2016,8);
